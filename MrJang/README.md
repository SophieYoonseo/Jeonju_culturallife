## 2019년 9월 27일 금요일
### 오늘의개발
1. 카카오 버튼을 "INSTAGRAM"에 나의 branch로 MERGE 시킴.
2. 카카오 버튼으로 로그인시, Cloud Firestore에 잘 등록시킴.

### 앞으로 해야할 일
1. 로그인 시 화면을 넘기는 방법 구현하기.
2. 로그인 시, 로그인 권한을 가지고 글 쓸 수 있게 하기.
3. 수정 / 삭제 기능 구현하기.
4. 구글/네이버도 마찬가지로 합치기.
...
### 오늘의개발
1. 카카오 버튼은 되는거 확인. 디버그 키 해시 때문에, 내 컴퓨터에서만 빌드된것만 제대로 실행된 것 이였음.
2. 어플 실행시 첫화면 디자인과 아이콘을 아는 후배에게 부탁함.
3. 여태껏 회의중 가장 이상적이고 열정적인 회의 조금씩 조금씩 나아지는 우리들의 모습.
